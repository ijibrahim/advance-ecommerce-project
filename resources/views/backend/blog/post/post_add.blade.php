                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="post_title_en" required="" class="form-control">
                                                    @error('post_title_en')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="post_title_bn" required="" class="form-control">
                                                    @error('post_title_bn')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="category_id" required="" class="form-control">
                                                        ...
                                                        <option value="{{ $category->id }}">{{ $category->blog_category_name_en }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                    @error('category_id')
