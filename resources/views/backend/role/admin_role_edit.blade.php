									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="controls">
													<input type="file" onchange="loadFile(event)" name="profile_photo_path" class="form-control" id="image"> 
												</div>
											</div>
										</div>
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_6" name="coupon"
                                                            value="1" {{ $adminuser->coupon == 1 ? 'checked' : ''  }} >
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <fieldset>
                                                        <input type="checkbox" id="checkbox_15" name="allusers"
                                                            value="1" {{ $adminuser->allusers == 1 ? 'checked' : ''  }} >
