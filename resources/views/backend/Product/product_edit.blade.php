                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_bn" class="form-control"
                                                         data-role="tagsinput" required="" value="{{ $products->product_tags_bn }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size_en" class="form-control"
                                                         data-role="tagsinput" required="" value="{{ $products->product_size_en }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size_bn" class="form-control"
                                                        data-role="tagsinput" required="" value="{{ $products->product_size_bn }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_color_en" class="form-control"
                                                         data-role="tagsinput" required="" value="{{ $products->product_color_en }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_color_bn" class="form-control"
                                                     data-role="tagsinput" required="" value="{{ $products->product_color_bn }}">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_en" id="textarea" class="form-control"
                                                        required="">{!! $products->sort_descp_en !!}</textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="sort_descp_bn" id="textarea" class="form-control"
                                                        required placeholder="Textarea">{!! $products->sort_descp_bn !!}</textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="editor2" name="long_descp_bn" rows="10" cols="80">{!! $products->long_descp_bn !!}</textarea>
                                                </div>
                                            </div>
            ...
            <div class="col-md-12">
                <div class="box bt-3 border-info">
                    <div class="box-header">
                        <h4>Product Multiple Image <strong>Update</strong></h4>
                    </div>
                    ...
                    <form action="{{ route('update-product-image') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="row row-sm">
                                ...
                                <div class="col-md-2">
                                    <div class="card">
                                        <img src="{{ asset($img->photo_name) }}" alt="{{ $products->product_name_en }}" class="card-img-top" title="{{ $products->product_name_en }}">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                                <a href="{{ route('product.multiimg.delete',$img->id) }}" class="btn btn-md btn-danger" id="delete" title="Delete Data"><i class="fa fa-trash"></i></a>
                                            </h5>
                                            <p class="card-text">
                                                <div class="form-group">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box bt-3 border-info">
                    <div class="box-header">
                        <h4>Product Thambnail Image <strong>Update</strong></h4>
                    </div>
                    ...
                    <form action="{{ route('update-product-thambnail') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="row row-sm">
                                ...
                                <div class="col-md-2">
                                    <div class="card">
                                        <img src="{{ asset($products->product_thambnail) }}" alt="{{ $products->product_thambnail }}" class="card-img-top" title="{{ $products->product_thambnail }}">
                                        <div class="card-body">
