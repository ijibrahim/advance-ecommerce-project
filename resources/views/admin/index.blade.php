...
@php
	...
	$panding = App\Models\Order::where('status','Panding')->get();
				...
				<div class="col-xl-3 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Yarly Sale</p>
				...
				<div class="col-xl-3 col-6">
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-mute mt-20 mb-0 font-size-16">Panding Orders</p>
								<h3 class="text-white mb-0 font-weight-500">{{ count($panding) }}<small class="text-danger"><i class="fa fa-caret-up"></i> Orders</small></h3>
							</div>
						</div>
					</div>
				</div>
...
@php
	$orders = App\Models\Order::where('status','Panding')->orderBy('id','DESC')->get();
@endphp
