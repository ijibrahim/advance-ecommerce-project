      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            <li><a href="#"><i class="icon fa fa-heart"></i> @if(session()->get('language') == 'bangla') উইস লিস্ট @else  My Wishlist  @endif </a></li>
            ...
            @else
            <li><a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>@if(session()->get('language') == 'bangla') লগইন / রেজিস্ট্রেশন @else Login/Register @endif</a></li>
            @endauth
          </ul>
        </div>
        <!-- /.cnt-account -->
                ...
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="category.html"> @if(session()->get('language') == 'bangla') ক্যাটাগরীস @else Categories  @endif <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu" >
                      ...
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">-  @if(session()->get('language') == 'bangla') {{ $category->category_name_bn }} @else {{ $category->category_name_en }}  @endif</a></li>
                      @endforeach
