    ...
    <div class="container">
      <div class="col-xs-12 col-sm-6 no-padding social">
        <ul class="link">
          ...
          <li class="googleplus pull-left"><a target="_blank" rel="nofollow" href="{{ $setting->facebook }}" title="GooglePlus"></a></li>
          <li class="rss pull-left"><a target="_blank" rel="nofollow" href="{{ $setting->facebook }}" title="RSS"></a></li>
          <li class="pintrest pull-left"><a target="_blank" rel="nofollow" href="{{ $setting->facebook }}" title="PInterest"></a></li>
