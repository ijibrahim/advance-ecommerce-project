{{-- <ul>
	...
	<li><img src="{{ asset($item->product_thambnail) }}" alt="" style="width: 30px; height: 30px;"> {{ $item->product_name_en }}</li>
	@endforeach
</ul>
 --}}
<style type="text/css">
        ...
        <div class="col-md-6">
            <div class="card">
            	...
            	<a href="{{ url('product/details/'.$item->id.'/'.$item->product_slug_en) }}">
	                <div class="list border-bottom"> <img src="{{ asset($item->product_thambnail) }}" alt="" style="width: 30px; height: 30px;">
