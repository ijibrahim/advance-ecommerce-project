                        ...
                        <div class='col-sm-6 col-md-7 product-info-block'>
                            <div class="product-info">
                                ...
                                <div class="description-container m-t-20">
                                    @if(session()->get('language') == 'bangla') {{ $product->sort_descp_bn }} @else
                                    {{ $product->sort_descp_en }} @endif
                                ...
                                <div class="price-container info-container m-t-20">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            $percent_selling_amount = $product->selling_price - $product->selling_price
                                            * $amount;
