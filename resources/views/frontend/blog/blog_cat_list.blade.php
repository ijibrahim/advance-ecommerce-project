                ...
                <div class="col-md-9">
                    ...
                    <div class="blog-post  wow fadeInUp">
                        <a href="{{ route('post.details', $blog->id) }}"><img class="img-responsive"
                                src="{{ asset($blog->post_image) }}" alt="@if(session()->get('language')=='bangla'){{$blog->post_title_bn}}@else{{$blog->post_title_en}}@endif"></a>
                        <h1>
                            <a href="blog-details.html">@if(session()->get('language')=='bangla'){{$blog->post_title_bn}}@else{{$blog->post_title_en}}@endif</a>
                        </h1>
                        ...
                        <div class="sidebar-widget outer-bottom-xs wow fadeInUp">
                            ...
                            <div class="sidebar-widget-body m-t-10">
                                <div class="accordion">
                                    ...
                                    @foreach($blogcatpost as $category)
                                    <ul class="list-group">
